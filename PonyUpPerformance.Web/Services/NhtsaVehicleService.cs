    ...
    public sealed class NhtsaVehicleService : IVinDecoderService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                profile.Series =
                    Clean(vehicle.Series);

                profile.Engine =
                    BuildEngineDescription(
                        vehicle);

                profile.EngineDisplacement =
                    Clean(vehicle.DisplacementL);

                profile.EngineCylinders =
                    Clean(vehicle.EngineCylinders);
                ...
                profile.Transmission =
                    Clean(vehicle.TransmissionStyle);

                profile.TransmissionStyle =
                    Clean(vehicle.TransmissionStyle);

                profile.Drivetrain =
                    Clean(vehicle.DriveType);

                profile.BodyStyle =
                    Clean(vehicle.BodyClass);

                profile.VehicleType =
                    Clean(vehicle.VehicleType);

                profile.FuelType =
                    Clean(vehicle.FuelTypePrimary);

                profile.Manufacturer =
                    Clean(vehicle.Manufacturer);

                profile.PlantCountry =
                    Clean(vehicle.PlantCountry);

                profile.PlantState =
                    Clean(vehicle.PlantState);

                profile.PlantCity =
                    Clean(vehicle.PlantCity);
            ...
            VpicVehicle vehicle)
        {
            ...
            {
                parts.Add(
                    $"{vehicle.EngineCylinders.Trim()} Cyl");
            }
